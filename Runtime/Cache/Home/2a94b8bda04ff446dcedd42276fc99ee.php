...
<html lang="zh-CN">
    <head>
        ...
        <link href="/Marxism/Marxism/Public/assets/global/styles/public.css" rel="stylesheet" type="text/css"/>
        <!-- END GLOBAL MANDATORY STYLES -->
        <!-- BEGIN PAGE STYLES -->
        <!-- [if IE] -->
        <!--  <script src="/Marxism/Marxism/Public/assets/global/plugins/ie8/html5shiv.min.js" type="text/javascript"></script> -->
        <script src="/Marxism/Marxism/Public/assets/global/plugins/ie8/respond.min.js" type="text/javascript"></script>
        <!--  <link rel="stylesheet" href="/Marxism/Marxism/Public/assets/global/styles/ie8-fix.css" type="text/css"/>-->
        <!-- [endif] -->

        
    <link rel="stylesheet" type="text/css" href="/Marxism/Marxism/Public/assets/global/plugins/zm-rotation/zm-rotation.css"/>
    <link href="/Marxism/Marxism/Public/assets/pages/styles/index.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
        <div class="container container-fluid">
            ...
            <div class="header">
                <img src="/Marxism/Marxism/Public/assets/global/img/back-roll.jpg" alt="江西师范大学">
            </div>
                        ...
                        <?php if(empty($news)): ?><li>暂无动态</li>
                            ...
                            <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                                    <div class="notice-list">
                                        <img src="/Marxism/Marxism/Public/assets/global/img/ico_17.jpg">
                    ...
                    <div class="box-center-content">
                        <div class="topic-pic">
                            <a target="_blank" href="<?php echo ($topic['url']); ?>" title="<?php echo ($topic['name']); ?>">
                                <br>
                                <img style="height: 0" src="/Marxism/Marxism/Public/uploads/<?php echo ($topic['path']); ?>" alt=""/>
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="link">
                <div class="link-img">
                    <img src="/Marxism/Marxism/Public/assets/global/img/link-img.png" alt=""></div>
                <div class="link-text">
                    <table>
                        <tr>
                            <td>
        ...
        <script type="text/javascript">
            ...
            var _ROOT_ = '/Marxism/Marxism',
                    ...
                    _ACTION_ = '/Marxism/Marxism/index.php/Home/Index/index',
                    _MODULE_ = '/Marxism/Marxism/index.php/Home',
                    _CONTROLLER_ = '/Marxism/Marxism/index.php/Home/Index';
        </script>
        <script type="text/javascript">
            window._ROOT_='/Marxism/Marxism';
            window._APP_='/Marxism/Marxism/index.php';
            window._ACTION_='<?php echo U("");?>';
            window._SELF_='<?php echo urldecode("/Marxism/Marxism/index.php");?>';
        </script>
        <!-- BEGIN CORE SCRIPTS -->
        <script src="/Marxism/Marxism/Public/assets/global/scripts/public.js" type="text/javascript"></script>
        <!-- END CORE SCRIPTS -->
        <!-- BEGIN PAGE LEVEL SCRIPTS -->
        
    <script type="text/javascript" src="/Marxism/Marxism/Public/assets/global/plugins/zm-rotation/jquery.zmrotation.js"></script>
    <script type="text/javascript" src="/Marxism/Marxism/Public/assets/pages/scripts/index_home.js"></script>
