...
var _ROOT_ = '/Marxism/Marxism',
    ...
    _ACTION_ = '/Marxism/Marxism/index.php/Achieve/Achiever/all',
    _MODULE_ = '/Marxism/Marxism/index.php/Achieve',
    _CONTROLLER_ = '/Marxism/Marxism/index.php/Achieve/Achiever';
</script>
<!-- BEGIN CORE PLUGINS -->
<!--[if lt IE 9]>
