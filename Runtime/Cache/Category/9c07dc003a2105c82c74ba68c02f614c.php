...
var _ROOT_ = '/Marxism/Marxism',
    ...
    _ACTION_ = '/Marxism/Marxism/index.php/Category/Category/all',
    _MODULE_ = '/Marxism/Marxism/index.php/Category',
    _CONTROLLER_ = '/Marxism/Marxism/index.php/Category/Category';
</script>
<!-- BEGIN CORE PLUGINS -->
<!--[if lt IE 9]>
