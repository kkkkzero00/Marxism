...
var _ROOT_ = '/Marxism/Marxism',
    ...
    _ACTION_ = '/Marxism/Marxism/index.php/BasisInfo/Student/all',
    _MODULE_ = '/Marxism/Marxism/index.php/BasisInfo',
    _CONTROLLER_ = '/Marxism/Marxism/index.php/BasisInfo/Student';
</script>
<!-- BEGIN CORE PLUGINS -->
<!--[if lt IE 9]>
